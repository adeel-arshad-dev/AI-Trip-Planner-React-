...
// import { AI_PROMPT, SelectBudgetList, SelectTravelersList } from "../component/constants/Option.jsx";
...
//     } else {
//       const promptForAi=AI_PROMPT(form);
...
//   apiKey: import.meta.env.VITE_GPT_API_URL,
...
//   let missingFields = [];
//   const [form, setform] = useState({});
//   const [tripPlan, setTripPlan] = useState(""); // ✅ store AI response
...
//       });
//       setTripPlan(completion.choices[0].message.content);
//     } catch (err) {
//       console.error(err);
...
//       {tripPlan && (
//         <div className="w-full max-w-2xl bg-white shadow-lg rounded-2xl p-5 mt-6">
//           <h2 className="text-lg font-bold mb-2">AI Suggested Trip Plan:</h2>
//           <pre className="whitespace-pre-wrap text-gray-700 text-sm sm:text-base">
//             {tripPlan}
//           </pre>
//         </div>
//       )}
...
export default function Create_trip() {
  ...
  method: "POST",
  headers: {
    "Authorization": `Bearer ${import.meta.env.VITE_GPT_API_URL}`,
...
if (data.choices && data.choices[0].message) {
  ...
  setTripPlan("No response received from AI.");
}
